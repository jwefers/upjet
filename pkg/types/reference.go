...
import (
	...
	"github.com/jwefers/upjet/v2/pkg/types/comments"
	"github.com/jwefers/upjet/v2/pkg/types/markers"
	"github.com/jwefers/upjet/v2/pkg/types/markers/kubebuilder"
...
const (
	...
	// with common APIs
	PackagePathXPCommonAPIs = "github.com/jwefers/crossplane-runtime/v2/apis/common/v1"
	// PackagePathXPV2CommonAPIs is the go path for the Crossplane Runtime package
	// with common v2 APIs
	PackagePathXPV2CommonAPIs = "github.com/jwefers/crossplane-runtime/v2/apis/common/v2"
)
